  ...
  <div class="video-carousel">
    <div v-if="showCarousel">
      ...
      <div class="wrapper">
        ...
        <button @click="shiftLeft" class="prev" ref="prev"><img src="icons/chevron-left.svg" alt="btnLeft" /></button>
        <button @click="shiftRight" class="next" ref="next"><img src="icons/chevron-right.svg" alt="btnRight" /></button>
      </div>
    </div>
  </div>
</template>
