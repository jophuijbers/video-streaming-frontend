<template>
  <div class="video-wrapper" ref="video-wrapper">
    ...
    <video :src="videoPath" @timeupdate="ended = false" @ended="videoEnded" controls :class="{'ended': ended}" ref="video-player" class="video-player" />
<!--    <p @click="goFullscreen">fullscreen</p>-->
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    // goFullscreen() {
    //   this.$refs['video-wrapper'].requestFullscreen()
    // },
  }
}
</script>
